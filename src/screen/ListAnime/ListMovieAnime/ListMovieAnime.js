...
import { GET_AIRED_ANIME, GET_EPISODES_ANIME, GET_SCORE_ANIME, GET_TOP_MOVIE_ANIME, GET_TYPE_ANIME } from '../../../constants/constants';
import { Rating } from 'react-native-ratings';
import { useNavigation } from '@react-navigation/native';
import { LoadingIndicator } from '../../../helper';
import { Ionicons } from '@expo/vector-icons';

const ListMovieAnime = () => {
  ...
  return (
    <SafeAreaView style={Styles.containerSection}>
      {loading ? <LoadingIndicator /> : listMovie.length > 0 ?
        <FlatList
          data={listMovie}
          renderItem={({ item }) =>
